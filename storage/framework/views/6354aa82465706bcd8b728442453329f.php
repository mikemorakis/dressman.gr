        ...
        <div class="border-b border-gray-100 flex-1 min-h-0">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
                <div class="flex items-center justify-between h-full">
                    ...
                    <a href="<?php echo e(url('/')); ?>" class="absolute left-1/2 -translate-x-1/2 lg:static lg:translate-x-0 lg:flex-1 lg:text-center flex flex-col items-center" aria-label="Dressman home">
        ...
        <div x-show="mobileMenu"
            ...
            <div x-show="mobileMenu"
                ...
                <div class="flex items-center justify-between px-4 h-16 border-b border-gray-200">
                    <img src="<?php echo e(asset('images/dressman-logo-big.png')); ?>" alt="Dressman" class="h-6 w-auto">
                    <button
                        type="button"
                        @click="mobileMenu = false"
                ...
                <div class="flex flex-col h-[calc(100%-4rem-3.5rem)]" x-data="{ tab: 'fashion' }">
                    ...
                    <nav class="flex-1 overflow-y-auto" aria-label="Mobile navigation">
                        ...
                        <div x-show="tab === 'fashion'" class="px-4 py-4 space-y-1">
                            <a href="<?php echo e(url('/product-category/gabriatika-kostoumia')); ?>" class="block px-3 py-2.5 text-base font-medium text-gray-900 hover:bg-gray-50">Γαμπριάτικα Κοστούμια</a>
                            <a href="<?php echo e(url('/product-category/rent')); ?>" class="block px-3 py-2.5 text-base font-medium text-gray-900 hover:bg-gray-50">Ενοικίαση</a>
                            <a href="<?php echo e(url('/metapoiisi')); ?>" class="block px-3 py-2.5 text-base font-medium text-gray-900 hover:bg-gray-50">Μεταποίηση</a>
                            <a href="<?php echo e(url('/made-to-measure')); ?>" class="block px-3 py-2.5 text-base font-medium text-gray-900 hover:bg-gray-50">Made to Measure</a>
                            
                            <div class="pt-2 mt-2 border-t border-gray-100">
                                <span class="block px-3 py-2 text-xs font-semibold uppercase tracking-wider text-gray-400">Ανδρικά Ρούχα</span>
                                <a href="<?php echo e(url('/product-category/kostoumia')); ?>" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 pl-6">Κοστούμια</a>
                                <a href="<?php echo e(url('/product-category/poykamisa')); ?>" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 pl-6">Πουκάμισα</a>
                                <a href="<?php echo e(url('/product-category/gileka')); ?>" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 pl-6">Γιλέκα</a>
                                <a href="<?php echo e(url('/product-category/sakakia')); ?>" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 pl-6">Σακάκια</a>
                                <a href="<?php echo e(url('/product-category/mplouzes')); ?>" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 pl-6">Μπλούζες</a>
                                <a href="<?php echo e(url('/product-category/pantelonia')); ?>" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 pl-6">Παντελόνια</a>
                                <a href="<?php echo e(url('/product-category/papoytsia')); ?>" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 pl-6">Παπούτσια</a>
                                <a href="<?php echo e(url('/product-category/axesouar')); ?>" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 pl-6">Αξεσουάρ</a>
                            </div>
                        </div>

                        
                        <div x-show="tab === 'links'" x-cloak class="px-4 py-4 space-y-1">
                            <a href="<?php echo e(url('/blog')); ?>" class="block px-3 py-2.5 text-base font-medium text-gray-900 hover:bg-gray-50">Blog</a>
                            <a href="<?php echo e(url('/#faq')); ?>" class="block px-3 py-2.5 text-base font-medium text-gray-900 hover:bg-gray-50">FAQ</a>
                            <a href="<?php echo e(url('/payment-methods')); ?>" class="block px-3 py-2.5 text-base font-medium text-gray-900 hover:bg-gray-50">Τρόποι Πληρωμής</a>
                            <a href="<?php echo e(url('/returns')); ?>" class="block px-3 py-2.5 text-base font-medium text-gray-900 hover:bg-gray-50">Επιστροφές Αγορών</a>
                            <a href="<?php echo e(url('/privacy')); ?>" class="block px-3 py-2.5 text-base font-medium text-gray-900 hover:bg-gray-50">Πολιτική Απορρήτου</a>
                            <a href="<?php echo e(url('/terms')); ?>" class="block px-3 py-2.5 text-base font-medium text-gray-900 hover:bg-gray-50">Όροι & Προϋποθέσεις</a>
                        </div>
                    </nav>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2" role="list">
                        ...
                        <li><a href="<?php echo e(url('/cookie-policy')); ?>" class="text-sm hover:text-white transition-colors">Πολιτική Cookies</a></li>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 py-5">
                ...
                <div class="sm:flex sm:items-start sm:justify-between sm:gap-6">
                    <div class="flex-1">
                        <p class="text-sm text-gray-700 leading-relaxed">
                            ...
                            <a href="<?php echo e(url('/cookie-policy')); ?>" class="underline hover:text-black">Πολιτική Cookies</a>
                        </p>
                    </div>
            ...
            <div x-show="expanded" x-cloak>
                ...
                <div class="mt-5 flex items-center justify-between">
                    <a href="<?php echo e(url('/cookie-policy')); ?>" class="text-sm text-gray-500 underline hover:text-black">Πολιτική Cookies</a>
