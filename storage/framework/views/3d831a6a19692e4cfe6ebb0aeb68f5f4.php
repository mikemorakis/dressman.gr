...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.seo-meta','data' => ['title' => 'Blog — '.e(config('app.name', 'PeShop')).'','description' => 'Read our latest articles, tips, and updates.','canonical' => route('blog.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Blog — '.e(config('app.name', 'PeShop')).'','description' => 'Read our latest articles, tips, and updates.','canonical' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('blog.index'))]); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\micha\Desktop\websites\shops\dressman\resources\views/pages/blog/index.blade.php ENDPATH**/ ?>